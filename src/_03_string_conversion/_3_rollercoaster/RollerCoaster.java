...
public class RollerCoaster {
	...
	public static void main(String[] args) {
		...
		if (heightAsInt <= 42) JOptionPane.showMessageDialog(null,"You can ride the coaster, with another person."); { }
		if (heightAsInt >= 48) JOptionPane.showMessageDialog(null,"You can ride the coaster."); { }
